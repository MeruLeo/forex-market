                ...
                >
                    ...
                    >
                        ...
                        <div className="flex gap-2 items-center justify-between">
                          <div className='w-1/2 font-light text-[12px] sm:text-sm lg:text-base text-nowrap' style={{color: theme === 'dark' ? '#E0E0E0' : 'black'}}>{dict.profile.password.old}: </div>
                        ...
                        <div className="flex gap-2 items-center justify-between">
                          <div className='w-1/2 font-light text-[12px] sm:text-sm lg:text-base text-nowrap' style={{color: theme === 'dark' ? '#E0E0E0' : 'black'}}>{dict.profile.password.new}</div>
                          <div className='w-full'>
                            <input
                            id="new-password"
                            type='password'
                    ...
                    <Button sx={{ textTransform: 'none',my: 1, fontFamily: '__Rubik_6eb173, __Rubik_Fallback_6eb173',color: theme === 'dark' ? '#E0E0E0' : 'black', }} fullWidth  variant="contained" color="error" size="large" onClick={handleChangePassword}  >
