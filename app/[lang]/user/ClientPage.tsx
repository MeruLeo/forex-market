    ...
    return (
        <main className="flex flex-col items-start sm:items-start w-full min-h-screen  md:pt-10">
            <div className="fixed bottom-0 left-0 md:relative flex h-full w-full items-center justify-center">
                <Tabs
                    defaultValue="trade"
                    className="w-full h-full flex flex-col items-center justify-center md:hidden object-cover "
                >
                    <div className="pt-16 w-full h-full object-cover pb-0 overflow-y-auto">
                        <TabsContent
                        ...
                        >
                            <Message
                                ...
                                len_trades={trades.length}
                                len_pending={pending.length}
                    ...
                    <TabsList className="my-2 md:my-0 mb-0">
                        <TabsTrigger
                            className="flex flex-col md:flex-row"
                            value="message"
                        >
                            <LuMessageSquare className=" md:mx-1" />
                            <span>{dict2.nav.message}</span>
                        </TabsTrigger>
                        <TabsTrigger
                            className="flex flex-col md:flex-row"
                            value="history"
                        >
                            <LuHistory className="md:mx-1" />
                            <span>{dict2.nav.history}</span>
                        </TabsTrigger>
                        <TabsTrigger
                            className="flex flex-col md:flex-row"
                            value="trade"
                        ...
                        <TabsTrigger
                            ...
                            value="price"
                        >
                            <CgArrowsExchangeAltV className="md:mx-1" />
                            <span>{dict2.nav.price}</span>
                        </TabsTrigger>
                    </TabsList>
                </Tabs>
            </div>
