    ...
    >
        ...
        >
            ...
            <form >
              ...
              <label htmlFor="wallet-amount"  className=' dark:text-white text-black'>{dict.wallet.balance} </label>
              <span className=' dark:text-white text-black mx-2 px-2 my-2'>{balance}</span>

              <Divider />
              

                <label htmlFor="wallet-amount"  className=' dark:text-white text-black'>{dict.wallet.wallet_equity} </label>
                <span className=' dark:text-white text-black mx-2 px-2 my-2'>{walletAmount}</span>
                <Divider />
               
              </div>
              <div>
                <label htmlFor="amount" className=' dark:text-white text-black'>{dict.wallet.amount} </label>
                <input
                  type="number"
                  step={0.01}
