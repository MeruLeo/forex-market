                        ...
                        <form>
                            <div className="flex flex-col w-full mb-4">
                                <div className="flex flex-col w-full mb-1">
                                    <label className=" dark:text-white text-black">
                                        {dict.copy_trade.current}{" "}
                                    </label>
                                    <span className=" dark:text-white text-black mx-2 px-2 my-2">
                                        {current_copy_from}
                                    </span>
                                </div>
                                ...
                                <div className="flex">
                                    <label
                                        htmlFor="curret_is_reverce"
                                        className=" dark:text-white text-black mx-2"
                                    >
                                        {dict.copy_trade.reversed}{" "}
                                    </label>
                                    <span className=" dark:text-white text-black mx-2">
                                        {current_copy_reverse
                                            ? dict.copy_trade.reverce_true
                                            : dict.copy_trade.reverce_false}
                                    </span>
                                </div>

                                <button
                                    className="text-black bg-orange-500 dark:text-white px-5 py-1 mx-2 mt-2 rounded"
                                    onClick={handleRemoveCopyTrade}
                                    disabled={is_loading}
                                >
                            ...
                            <div className="flex flex-col w-full mb-3">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    >
                                        ...
                                        <select
                                            ...
                                            disabled={is_loading}
                                            onChange={(e) =>
                                                setNewCopySymbol(e.target.value)
                                            }
                                            className="w-full rounded border-[1.5px] border-stroke bg-white px-4 py-1.5 font-light text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-zinc-800 dark:text-white dark:focus:border-primary text-sm xl:text-base"
                                        >
                                ...
                                <div className="flex mt-2">
                                    ...
                                    <Checkbox
                                        id="curret_is_reverce"
                                        checked={new_copy_reverse}
                                        onCheckedChange={() =>
                                            setNewCopyReverse(!new_copy_reverse)
                                        }
                                    />
                                </div>
