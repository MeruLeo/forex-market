...
const getDictionary_user = (language: Language) =>
    dictionaries_user[language]();
...
export function UserNav({ lang }: { lang: string }) {
    ...
    useEffect(() => {
        ...
        if (typeof window !== "undefined") {
            const token_id = Cookies.get("access"); // Get the token from sessionStorage
