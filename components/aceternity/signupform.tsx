  ...
  {dict:any; lang:string}
    ...
    useEffect(() => {
      ...
      const fetchConf = async () => {
        try {
          const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL2}/get-site-config`);
        ...
        try {
            ...
            if (response.ok) {
                ...
                if(needSmsVerify){
                  ...
                  try {
                      const loginResponse = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/account/login`, {
                          method: 'POST',
                          headers: {
                              'Content-Type': 'application/json',
                          },
